...
<header class="topBar">
    <a href="{{ $licence ? '/licences' : '/' }}" class="f_l"><i class="iconFont"></i></a>
    <a href="{{ $licence ? '/licences' : '/' }}" class="f_r"><!-- <i class="iconFont">&#xe615;</i> --></a>{{ $licence ? '提交关注' : '用户留言' }}
</header>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            ...
                                            <input style="width: 150px" type="text" id="phone" name="phone" value="" class="form-control phone" placeholder="输入 手机" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
